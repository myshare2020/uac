...
intrinsic_macro(get_core_sym) \
intrinsic_macro(get_app_fee) \
intrinsic_macro(new_app_sym) \
intrinsic_macro(get_sym_issuer)
// by myextend
// get_core_sym, get_app_fee, new_app_sym, get_sym_issuer
//
