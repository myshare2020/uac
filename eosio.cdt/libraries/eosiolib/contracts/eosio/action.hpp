...
namespace eosio {
   ...
   namespace internal_use_do_not_use {
      extern "C" {
         ...
         __attribute__((eosio_wasm_import))
         uint64_t get_app_fee( uint64_t sym, int64_t value, int64_t* fee );
         __attribute__((eosio_wasm_import))
         void new_app_sym( uint64_t sym, uint64_t owner, uint64_t issuer );
         __attribute__((eosio_wasm_import))
         uint64_t get_sym_issuer( uint64_t sym );
         //
   ...
   // by myextend
   inline uint64_t get_core_sym() {
      return internal_use_do_not_use::get_core_sym();
   }
   inline name get_app_fee( uint64_t sym, int64_t value, int64_t* fee ) {
      return name(internal_use_do_not_use::get_app_fee( sym, value, fee ));
   }
   inline void new_app_sym( uint64_t sym, uint64_t owner, uint64_t issuer ) {
      internal_use_do_not_use::new_app_sym( sym, owner, issuer );
   }
   inline name get_sym_issuer( uint64_t sym ) {
      return name(internal_use_do_not_use::get_sym_issuer( sym ));
   }
   //
